...
const tCelsiy = Number.parseFloat(prompt("Введите температуру в градусах Цельсия"));    
const tFareng = (9 / 5) * tCelsiy + 32;
const result = Math.floor(tFareng * 100) / 100;
alert(`Цельсий: ${tCelsiy}, Фаренгейт: ${result}`);
